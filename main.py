...
class MainWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.create_labeled_widget(QLineEdit(), 'send_time', 'Horario de envio: (hh:mm)')
    ...
    def create_labeled_widget(self, widget:QWidget, field_name:str, label_message:str):
    ...
    def configure_layout_layouts(self, layout:QVBoxLayout, *args:QHBoxLayout|QVBoxLayout):
        for widget in args:
